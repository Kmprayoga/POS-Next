  ...
  return (
    ...
    <>
      <div className="inventual-content-area px-4 sm:px-7">
        <div className="inventual-customerlist bg-white p-5 sm:p-7 custom-shadow rounded-8 mt-7">
          <div className="inventual-product-top-btn flex flex-wrap gap-5 mb-7">
            <Link className='inventual-btn secondary-btn' href="/people/addcustomer">
