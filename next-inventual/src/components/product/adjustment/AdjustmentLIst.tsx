  ...
  return (
    <>
      <div className="inventual-content-area px-4 sm:px-7">
        <div className="inventual-adjustment-area bg-white p-5 sm:p-7 custom-shadow rounded-8 mt-7">
          <div className="inventual-product-top-btn flex flex-wrap gap-5 mb-7">
            <Link className='inventual-btn secondary-btn' href="/product/addadjustment"><span><i className="fa-regular fa-circle-plus"></i></span>Add Adjustment</Link>
          </div>
                                      ...
                                      <PopupState variant="popover">
                                        {(popupState: any) => (
                                          <React.Fragment>
                                            ...
                                            <Menu {...bindMenu(popupState)}>
                                              <MenuItem onClick={popupState.close}><Link href='/product/addadjustment'><i className="fa-regular fa-pen-to-square"></i>Edit</Link></MenuItem>
