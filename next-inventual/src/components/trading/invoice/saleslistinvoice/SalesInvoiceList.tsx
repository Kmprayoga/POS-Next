...
const SalesInvoiceList = () => {
  ...
  const [orderBy, setOrderBy] = useState<keyof Data>('Phone');
      ...
      <div className="inventual-content-area px-4 sm:px-7">
        <div className="inventual-report-area bg-white p-5 sm:p-7 custom-shadow rounded-8 mt-7">
          <div className="inventual-product-top-btn flex flex-wrap gap-5 mb-7">
            <Link className='inventual-btn secondary-btn' href="/trading/invoice/saleinvoice"><span><i className="fa-regular fa-circle-plus"></i></span>Add Sale Invoice</Link>
            <div className="file-import-btn-wrapper">
              <Link className='inventual-btn primary-btn' href="/trading/invoice/importInvoice"><span><i className="fa-regular fa-folder-arrow-up"></i></span>Import Sale Invoice</Link>
            </div>
          </div>
                      ...
                      {(popupState: any) => (
                        <React.Fragment>
                          ...
                          <Menu {...bindMenu(popupState)}>
                            ...
                            <MenuItem onClick={popupState.close}>Payment Status</MenuItem>
                          </Menu>
                        </React.Fragment>
                      )}
                    </PopupState>
                                      ...
                                      <PopupState variant="popover">
                                        {(popupState: any) => (
                                          <React.Fragment>
                                            ...
                                            <Menu {...bindMenu(popupState)}>
                                              <MenuItem onClick={popupState.close}><i className="fa-regular fa-pen-to-square"></i><Link href='/trading/invoice/saleinvoice'>Edit</Link></MenuItem>
