...
const PurchaseReturnsList = () => {
  ...
  const [orderBy, setOrderBy] = useState<keyof Data>('id');
   ...
   const handleAddReturnDialogClose = () => {
     setOpenPurchaseReturnDialog(true);
   };
   const handlePurchaseReturnDialogClose = () => {
     setOpenPurchaseReturnDialog(false);
   };
  ...
  return (
    ...
    <>
      <div className="inventual-content-area px-4 sm:px-7">
        <div className="inventual-report-area bg-white p-5 sm:p-7 custom-shadow rounded-8 mt-7">
          <div className="inventual-product-top-btn flex flex-wrap gap-5 mb-7">
            <button
            onClick={handleAddReturnDialogClose}
              className='inventual-btn'>
      ...
      <AddReturnPopup open={openPurchaseReturnDialog} handlePurchaseReturnDialogClose={handlePurchaseReturnDialogClose}/>
