    ...
    <>
      <div className="inventual-content-area px-4 sm:px-7">
        <div className="inventual-report-area bg-white p-5 sm:p-7 custom-shadow rounded-8 mt-7">
          <div className="grid grid-cols-10 gap-y-7 sm:gap-7 mb-7 items-end">
            <div className="col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-2">
              ...
              <div className="inventual-form-field">
                ...
                <div className="inventual-select-field-style">
                  ...
                  >
                    ...
                    <MenuItem value="Daily">Warehouse 1</MenuItem>
                    <MenuItem value="Daily">Warehouse 2</MenuItem>
                    <MenuItem value="Daily">Warehouse 3</MenuItem>
                    <MenuItem value="Daily">Warehouse 4</MenuItem>
                  </TextField>
                </div>
              </div>
            </div>
                        ...
                        <Table aria-label="enhanced table" size="medium">
                            ...
                            <TableRow>
                              ...
                              <TableCell>
                                <TableSortLabel
                                  ...
                                  onClick={() => handleRequestSort('invoiceNo')}
                                >
                                  Invoice No
                                </TableSortLabel>
                              </TableCell>
                              <TableCell>
                                <TableSortLabel
                                  ...
                                  direction={orderBy === 'discountAmount' ? order : 'asc'}
                                  onClick={() => handleRequestSort('discountAmount')}
                                >
                                  Amount
                                </TableSortLabel>
                              </TableCell>
                          ...
                          <TableBody>
                            ...
                            <TableRow>
                              ...
                              <TableCell><span className="font-semibold text-heading">$1965652</span></TableCell>
                            </TableRow>
                          </TableBody>
                        </Table>
                      </TableContainer>
