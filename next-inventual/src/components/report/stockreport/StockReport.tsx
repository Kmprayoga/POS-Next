                      ...
                      {(popupState: any) => (
                        <React.Fragment>
                          ...
                          <Menu {...bindMenu(popupState)}>
                            ...
                            <MenuItem onClick={popupState.close}>Opening Stock</MenuItem>
                            <MenuItem onClick={popupState.close}>Closing Stock</MenuItem>
                          </Menu>
                        </React.Fragment>
                      )}
                    </PopupState>
                        ...
                        <Table aria-label="enhanced table" size="medium">
                          <TableHead className='bg-lightest'>
                            <TableRow>
                              ...
                              <TableCell>
                                <TableSortLabel
                                  active={orderBy === 'openingStock'}
                                  direction={orderBy === 'openingStock' ? order : 'asc'}
                              ...
                              <TableCell>
                                <TableSortLabel
                                  ...
                                  onClick={() => handleRequestSort('received')}
                                >
                                  Received
                                </TableSortLabel>
                              </TableCell>
                              ...
                              <TableCell>
                                <TableSortLabel
                                  active={orderBy === 'closingStock'}
                                  direction={orderBy === 'closingStock' ? order : 'asc'}
                          ...
                          <TableBody>
                            ...
                            <TableRow>
                              ...
                              <TableCell><span className="font-semibold text-heading">5460</span></TableCell>
                              <TableCell><span className="font-semibold text-heading">6750</span></TableCell>
                              <TableCell><span className="font-semibold text-heading">9870</span></TableCell>
                              <TableCell><span className="font-semibold text-heading">900</span></TableCell>
                              <TableCell><span className="font-semibold text-heading">1200</span></TableCell>
                            </TableRow>
                          </TableBody>
                        </Table>
                      </TableContainer>
