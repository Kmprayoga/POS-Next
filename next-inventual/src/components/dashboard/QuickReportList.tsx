                    ...
                    <div className="maxSm:col-span-12 md:col-span-6 lg:col-span-4 minMax2Xl:col-span-6">
                        <div className="invention-quickreport flex items-center bg-white mb-5 rounded-8 p-7 gap-y-5 minMaxXl:flex-col">
                            ...
                            <div className="invention-quickreport-text">
                                ...
                                <h5 className="text-[20px] text-heading font-bold">Rp585,420</h5>
                            </div>
                        </div>
                    </div>
                    <div className="maxSm:col-span-12 md:col-span-6 lg:col-span-4 minMax2Xl:col-span-6">
                        <div className="invention-quickreport flex items-center bg-white mb-5 rounded-8 p-7 gap-y-5 minMaxXl:flex-col">
                            ...
                            <div className="invention-quickreport-text">
                                ...
                                <h5 className="text-[20px] text-heading font-bold">Rp237,813</h5>
                            </div>
                        </div>
                    </div>
                    <div className="maxSm:col-span-12 md:col-span-6 lg:col-span-4 minMax2Xl:col-span-6">
                    ...
                    <div className="maxSm:col-span-12 md:col-span-6 lg:col-span-4 minMax2Xl:col-span-6">
                        <div className="invention-quickreport flex items-center bg-white mb-5 rounded-8 p-7 gap-y-5 minMaxXl:flex-col">
                            ...
                            <div className="invention-quickreport-text">
                                ...
                                <h5 className="text-[20px] text-heading font-bold">3</h5>
                            </div>
                        </div>
                    </div>
                    <div className="maxSm:col-span-12 md:col-span-6 lg:col-span-4 minMax2Xl:col-span-6">
                        <div className="invention-quickreport flex items-center bg-white mb-5 rounded-8 p-7 gap-y-5 minMaxXl:flex-col">
                            ...
                            <div className="invention-quickreport-text">
                                ...
                                <h5 className="text-[20px] text-heading font-bold">Rp423,703</h5>
                            </div>
                        </div>
                    </div>
                    <div className="maxSm:col-span-12 md:col-span-6 lg:col-span-4 minMax2Xl:col-span-6">
                        <div className="invention-quickreport flex items-center bg-white mb-5 rounded-8 p-7 gap-y-5 minMaxXl:flex-col">
                            ...
                            <div className="invention-quickreport-text">
                                ...
                                <h5 className="text-[20px] text-heading font-bold">Rp229,035</h5>
                            </div>
                        </div>
                    </div>
                </div>
