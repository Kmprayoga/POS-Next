...
const ReportRoleList = () => {
    ...
    const handleSelectAllChange = (event: any) => {
        ...
        setChildCheckboxStates({
            ...
            paymentReport: isChecked,
            discountReport: isChecked,
                        ...
                        <div className="inventual-role-checkbox-wrapper inventual-role-checkbox-wrapper2">
                            ...
                            <div className='inventual-checkbox-style'>
                                <FormControlLabel
                                    control={
                                        <Checkbox
                                            checked={childCheckboxStates.paymentReport}
                                            onChange={handleChildCheckboxChange}
                                            name="paymentReport"
                                            inputProps={{ 'aria-label': 'controlled' }}
                                        />
                            ...
                            <div className='inventual-checkbox-style'>
                                <FormControlLabel
                                    control={
                                        <Checkbox
                                            checked={childCheckboxStates.discountReport}
                                            onChange={handleChildCheckboxChange}
                                            name="discountReport"
                                            inputProps={{ 'aria-label': 'controlled' }}
                                        />
                        ...
                        <div className="inventual-role-checkbox-wrapper inventual-role-checkbox-wrapper2">
                            ...
                            <div className='inventual-checkbox-style'>
                                <FormControlLabel
                                    control={
                                        <Checkbox
                                            checked={childCheckboxStates.taxReport}
                                            onChange={handleChildCheckboxChange}
                                            name="taxReport"
                                            inputProps={{ 'aria-label': 'controlled' }}
                                        />
                        ...
                        <div className="inventual-role-checkbox-wrapper inventual-role-checkbox-wrapper2">
                            ...
                            <div className='inventual-checkbox-style'>
                                <FormControlLabel
                                    control={
                                        <Checkbox
                                            checked={childCheckboxStates.shippingCharge}
                                            onChange={handleChildCheckboxChange}
                                            name="shippingCharge"
                                            inputProps={{ 'aria-label': 'controlled' }}
                                        />
