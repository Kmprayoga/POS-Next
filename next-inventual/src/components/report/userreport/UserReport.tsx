...
const rows: Data[] = [
  ...
  },
  {
    ...
    address: '1234 Blue Street, Los Angeles, CA 90001',
    status: 'Offline',
  },
  {
    id: 3,
    ...
    phone: '+02 585 339 203',
    role: 'Admin',
    email: 'matthew@example.com',
    address: '5678 Red Road, San Francisco, CA 94110',
    status: 'Online',
  },
  {
    id: 4,
    sl: '04',
    name: 'Danyelle Lundy',
    phone: '+02 585 339 204',
    role: 'Manager',
    email: 'danyelle@example.com',
    address: '9101 Yellow Avenue, Sacramento, CA 94203',
    status: 'Offline',
  },
  {
    id: 5,
    sl: '05',
    name: 'Glenn Weiner',
    phone: '+02 585 339 205',
    role: 'Supervisor',
    email: 'glenn@example.com',
    address: '1112 Orange Street, Fresno, CA 93721',
    status: 'Online',
  },
  {
    id: 6,
    sl: '06',
    name: 'Rosemary Clark',
    phone: '+02 585 339 206',
    role: 'Biller',
    email: 'rosemary@example.com',
    address: '1314 Purple Avenue, Bakersfield, CA 93301',
    status: 'Offline',
  },
  {
    id: 7,
    ...
    phone: '+02 585 339 207',
    role: 'Biller',
    email: 'jennifer@example.com',
    address: '1516 Green Way, Anaheim, CA 92801',
    status: 'Online',
  },
  {
    id: 8,
    sl: '08',
    name: 'Donald Boser',
    phone: '+02 585 339 208',
    role: 'Biller',
    email: 'donald@example.com',
    address: '1718 Brown Boulevard, Riverside, CA 92501',
    status: 'Offline',
  },
  {
    id: 9,
    sl: '09',
    name: 'Maria Cavallo',
    phone: '+02 585 339 209',
    role: 'Biller',
    email: 'maria@example.com',
    address: '1920 Gray Street, Stockton, CA 95202',
    status: 'Online',
  },
  {
    id: 10,
    sl: '10',
    name: 'James Smith',
    phone: '+02 585 339 210',
    role: 'Supervisor',
    email: 'james@example.com',
    address: '2122 Pink Lane, Chula Vista, CA 91910',
    status: 'Offline',
  },
...
const UserReport = () => {
  ...
  const [orderBy, setOrderBy] = useState<keyof Data>('role');
