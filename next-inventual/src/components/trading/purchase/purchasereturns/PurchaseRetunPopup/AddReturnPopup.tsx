...
interface AddReturnPopupProps {
    open: boolean;
    handlePurchaseReturnDialogClose: () => void;
}

const AddReturnPopup: React.FC<AddReturnPopupProps> = ({ open, handlePurchaseReturnDialogClose }) => {
                            ...
                            <div className="grid grid-cols-12 sm:gap-x-[30px] gap-y-[18px]">
                                ...
                                <div className="col-span-12 md:col-span-6">
                                    <div className="inventual-form-field">
                                        <h5>Reference</h5>
                                        <div className="inventual-input-field-style">
                                            <input type="text" placeholder='S-34435454354' />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-span-12 md:col-span-6">
